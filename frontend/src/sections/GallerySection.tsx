...
export default function GallerySection() {
  return (
    <Section bgColor='bg-white' id="gallery" className="py-32 ">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        {/* Header */}
        <div className="flex justify-between items-end mb-16">
          <div>
            <span className=" font-label text-sm tracking-[0.3em] uppercase mb-4 block">
              Recent Moments
            </span>
            <h2 className="font-headline text-5xl italic">Life in the Sanctuary</h2>
          </div>
          <a
            href="#"
